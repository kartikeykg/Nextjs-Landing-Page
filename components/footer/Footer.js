    ...
    <section className="footer section">
      <Container>
        <Row>
          <Col lg={4}>
              <div className="mb-4">
                <p className="text-muted mt-4 mb-2">landingpage001@email.com</p>
                <h6 className="text-muted font-weight-normal">+91 9865985869</h6>
              </div>
          </Col>
          <Col lg={8}>
            <Row>
              ...
              <Col md={4}>
                ...
                <h6 className="text-muted pb-2">Email: landingpage001@email.com</h6>
        ...
        <Row className="mt-5">
          <Col md={12}>
            <div className="text-center text-muted">
              <p className="mb-0 f-15">2022 © Build By KARTIKYE GAUTAM </p>
            </div>
          </Col>
        </Row>
      </Container>
